...
developed_countries_df_2014 = pd.DataFrame(columns=['country', 'govt_subsidies', 'govt_consumption', 'state_owned', 'tax_revenue'])

for country in developed_countries:
    developed_countries_df_2014 = developed_countries_df_2014.append({'country': country,
                                                                     'govt_subsidies': GOVERNMENT_SUBSIDIES_AND_TRANSFERS_DF[country]["2014"],
                                                                     'govt_consumption': GOVERNMENT_CONSUMPTION_DF[country]["2014"],
                                                                     'state_owned': STATE_OWNED_ENTERPRISES_DF[country]["2014"],
                                                                     'tax_revenue': GOVERNMENT_TAXREVENUE_DF[country]["2014"]}, ignore_index=True)


# In[11]:


developed_countries_df_2014 = developed_countries_df_2014.dropna()
developed_countries_df_2014 = developed_countries_df_2014.set_index("country")
developed_countries_df_2014
...
developing_countries_df_2014 = pd.DataFrame(columns=['country', 'govt_subsidies', 'govt_consumption', 'state_owned', 'tax_revenue'])

for country in developing_countries:
    developing_countries_df_2014 = developing_countries_df_2014.append({'country': country,
                                                                     'govt_subsidies': GOVERNMENT_SUBSIDIES_AND_TRANSFERS_DF[country]["2014"],
                                                                     'govt_consumption': GOVERNMENT_CONSUMPTION_DF[country]["2014"],
                                                                     'state_owned': STATE_OWNED_ENTERPRISES_DF[country]["2014"],
                                                                     'tax_revenue': GOVERNMENT_TAXREVENUE_DF[country]["2014"]}, ignore_index=True)
...
developing_countries_df_2014 = developing_countries_df_2014.dropna()
developing_countries_df_2014 = developing_countries_df_2014.set_index("country")
developing_countries_df_2014
...
developing_countries_df_2014["category"] = cluster.fit_predict(developing_countries_df_2014.values)

developing_category1 = developing_countries_df_2014.loc[developing_countries_df_2014['category'] == 1]
developing_category0 = developing_countries_df_2014.loc[developing_countries_df_2014['category'] == 0]
...
developed_countries_df_2014["category"] = cluster.fit_predict(developed_countries_df_2014.values)

point1 = developed_countries_df_2014.loc[developed_countries_df_2014['category'] == 1]
point2 = developed_countries_df_2014.loc[developed_countries_df_2014['category'] == 0]
...
developed_countries_df_2014["growth_rate"] = [GDP_GROWTH_ANNUM_DF[country]["2014"] for country in developed_countries if country in developed_countries_df_2014.index]
...
growth_mean = developed_countries_df_2014["growth_rate"].mean()
...
for outlier in outliers:
    country_name[country.loc[country['2014'] == outlier].index[0]] = outlier
...
developing_countries_df_2014["growth_rate"] = [GDP_GROWTH_ANNUM_DF[country]["2014"] for country in developing_countries if country in developing_countries_df_2014.index]
...
growth_mean = developing_countries_df_2014["growth_rate"].mean()
