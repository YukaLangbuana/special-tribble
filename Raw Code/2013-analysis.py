...
developed_countries_df_2013 = pd.DataFrame(columns=['country', 'govt_subsidies', 'govt_consumption', 'state_owned', 'tax_revenue'])

for country in developed_countries:
    developed_countries_df_2013 = developed_countries_df_2013.append({'country': country,
                                                                     'govt_subsidies': GOVERNMENT_SUBSIDIES_AND_TRANSFERS_DF[country]["2013"],
                                                                     'govt_consumption': GOVERNMENT_CONSUMPTION_DF[country]["2013"],
                                                                     'state_owned': STATE_OWNED_ENTERPRISES_DF[country]["2013"],
                                                                     'tax_revenue': GOVERNMENT_TAXREVENUE_DF[country]["2013"]}, ignore_index=True)


# In[11]:


developed_countries_df_2013 = developed_countries_df_2013.dropna()
developed_countries_df_2013 = developed_countries_df_2013.set_index("country")
developed_countries_df_2013


# In[12]:


developed_countries_df_2013.head()
...
developing_countries_df_2013 = pd.DataFrame(columns=['country', 'govt_subsidies', 'govt_consumption', 'state_owned', 'tax_revenue'])

for country in developing_countries:
    developing_countries_df_2013 = developing_countries_df_2013.append({'country': country,
                                                                     'govt_subsidies': GOVERNMENT_SUBSIDIES_AND_TRANSFERS_DF[country]["2013"],
                                                                     'govt_consumption': GOVERNMENT_CONSUMPTION_DF[country]["2013"],
                                                                     'state_owned': STATE_OWNED_ENTERPRISES_DF[country]["2013"],
                                                                     'tax_revenue': GOVERNMENT_TAXREVENUE_DF[country]["2013"]}, ignore_index=True)
...
developing_countries_df_2013 = developing_countries_df_2013.dropna()
developing_countries_df_2013 = developing_countries_df_2013.set_index("country")
developing_countries_df_2013
...
developing_countries_df_2013["category"] = cluster.fit_predict(developing_countries_df_2013.values)

developing_category1 = developing_countries_df_2013.loc[developing_countries_df_2013['category'] == 1]
developing_category0 = developing_countries_df_2013.loc[developing_countries_df_2013['category'] == 0]
...
developed_countries_df_2013["category"] = cluster.fit_predict(developed_countries_df_2013.values)

point1 = developed_countries_df_2013.loc[developed_countries_df_2013['category'] == 1]
point2 = developed_countries_df_2013.loc[developed_countries_df_2013['category'] == 0]
...
developed_countries_df_2013["growth_rate"] = [GDP_GROWTH_ANNUM_DF[country]["2013"] for country in developed_countries if country in developed_countries_df_2013.index]
...
growth_mean = developed_countries_df_2013["growth_rate"].mean()
...
for outlier in outliers:
    country_name[country.loc[country['2013'] == outlier].index[0]] = outlier
...
developing_countries_df_2013["growth_rate"] = [GDP_GROWTH_ANNUM_DF[country]["2013"] for country in developing_countries if country in developing_countries_df_2013.index]
...
growth_mean = developing_countries_df_2013["growth_rate"].mean()
